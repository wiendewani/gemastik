...
def read_args():
    ...
    ap.add_argument("-d", "--training", required=True, help="E:/KULIAH/GEMASTIK/Penyakit Apel/train")
    ap.add_argument("-t", "--test", required=True, help="E:/KULIAH/GEMASTIK/Penyakit Apel/test")
...
for imagePath in paths.list_images("E:/KULIAH/GEMASTIK/Penyakit Apel/train"):
...
for (i, imagePath) in enumerate(paths.list_images("E:/KULIAH/GEMASTIK/Penyakit Apel/test")):
